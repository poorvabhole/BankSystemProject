...
public class AccountController {
    ...
    public ResponseEntity<AccountListResponse> transactionBetweenCustomers(@PathParam("customerId1") Integer customerId1,
                                                                     @PathParam("accountNumber1") String accountNumber1,
                                                                     @PathParam("customerId2") Integer customerId2,
                                                                     @PathParam("accountNumber2") String accountNumber2, @PathParam(value = "amount") Double amount) {
        return new ResponseEntity<>(accountService.transactionBetweenCustomers(customerId1, accountNumber1, customerId2, accountNumber2, amount), HttpStatus.OK);
    }
